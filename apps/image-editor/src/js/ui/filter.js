...
const PICKER_CONTROL_HEIGHT = '170px';
...
class Filter extends Submenu {
  ...
  _changeFilterState(applyFilter, filterName, isLast = true) {
    ...
    switch (filterName) {
      case 'removeWhite':
        filterRange = this._els.removewhiteDistanceRange;
        break;
      case 'brightness':
        filterRange = this._els.brightnessRange;
        break;
      case 'noise':
        filterRange = this._els.noiseRange;
        break;
      case 'pixelate':
        filterRange = this._els.pixelateRange;
        break;
      case 'colorFilter':
        filterRange = this._els.colorfilterThresholdRange;
        break;
      default:
        break;
    }
    if (checkboxGroup && filterRange) {
      filterRange.disabled = !apply;
    }
